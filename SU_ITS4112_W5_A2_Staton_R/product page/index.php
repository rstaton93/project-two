                ...
                if(!empty($_SESSION["cart_item"])) {
                    if (in_array($productByCode[0]["code"], array_keys($_SESSION["cart_item"]))) {
                        foreach ($_SESSION["cart_item"] as $k => $v) {
                            if ($productByCode[0]["cart_item"] == $k) {
...
<HTML>
    <HEAD>
        ...
        <link href="style.ccs" type="text/ccs" rel="stylesheet" />
    </HEAD>
    <BODY>
        <div id="shipping-cart">
    ...
    foreach ($_SESSION["cart_item"] as $item) {
        ...
        <tr>
            <td><img src="<?php echo $item["image"]; ?>"
                class="cart-item-imgae" /><?php echo $item["name"]; ?></td>
...
<?php
    ...
    ?>
    </div class="no-record">Your Cart is Empty</div>
    <?php
}
?>
</div>
    ...
    if (! empty($product_array)) {
        ...
        <div class="product-title-footer">
            ...
            <div class="cart-action">
                <input type="text" class="production-quantity" name="quantity"
